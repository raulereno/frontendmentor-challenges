...
const InteractiveRatingComponent = () => {
  ...
  if (view) {
    return <SubmitRatingComponent rating={rating} />;
  }

  return (
    <div className="container_interactiveRating">
...
const SubmitRatingComponent = ({ rating }) => {
  const [backView, setBackView] = useState(false);

  if (backView) {
    return <InteractiveRatingComponent />;
  }
  ...
  return (
    <div className="container_interactiveRating">
      <div className="container_submit">
        ...
        <p className="rating_submit">You selected {rating} out of 5</p>

        <p className="thanks_text">Thanks you!</p>

        <p className="text">
          We appreciate you taking the time to give a rating. If you ever need
          more support, don't hesitate to get in touch!
        </p>
        <p className="back" onClick={() => setBackView(true)}>
          Back
        </p>
      </div>
    </div>
